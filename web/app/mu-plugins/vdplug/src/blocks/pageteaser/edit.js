                ...
                pickBy(
                    {
                        ...
                        type: ['page', 'post', 'vd_job', 'vd_location'],
                        context: 'edit',
                        order,
                        orderby: orderBy,
                        per_page: postsToShow,
        ...
        <>
            ...
            <div {...blockProps}>
                ...
                <div className={classnames({
                    'grid-columns': postLayout === 'grid',
                    [`grid-columns--max${columns}`]: postLayout === 'grid',
                    'grid-list': postLayout === 'list'
                })}>
                    ...
                    {displayPosts.map((post) => {
                        ...
                        return (
                            <div className="teaser" key={`teaser-${post.id}`}><article>
                                ...
                                <div className="teaser__inner">
                                    ...
                                    {postLayout === 'grid' ?
                                        ...
                                        <h3 className="teaser__title" dangerouslySetInnerHTML={{ __html: titleTrimmed }} />
                                    }
                                    {displayPostDate && post.date_gmt && (
                                        <time
                                            dateTime={format('c', post.date_gmt)}
                                            className="teaser__post-date"
                                        >
                                    ...
                                    {displayPostContent && displayPostContentRadio === 'full_post' && (
                                        <div
                                            className="teaser__full-content"
                ...
                { /* Load more */}
                {displayLoadmore && <div className="pageteaser__footer">
