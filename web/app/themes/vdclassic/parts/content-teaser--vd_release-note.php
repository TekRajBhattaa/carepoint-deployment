...
<article id="post-<?php the_ID(); ?>" <?php post_class('teaser'); ?>>
    <figure class="wp-block-image">
        <a href="<?php the_permalink(); ?>" class="teaser__media">
            ...
            if (has_post_thumbnail()) {
                ...
                if ($term->term_image) {
                    $head_img = wp_get_attachment_image($term->term_image, 'medium', false, array('class' => 'category-header__image'));
                } else {
    ...
    <div class="teaser__inner">
        ...
        <div class="teaser__actions">
            <div class="readmore">
                <a href="<?php the_permalink(); ?>"><?php echo _e('Read More', 'vdclassic') ?></a>
            </div>
        </div>
    </div>
