 ...
 *
 * Example query:
 * https://to.com.ddev.site/wp-json/wp/v2/multiple-post-type?&type[]=post&type[]=page
 *
...
class WP_REST_MultiplePostType_Controller extends WP_REST_Controller
{
    ...
    public function get_items($request)
    {
        ...
        $args['page_category']       = $request['page_taxonomy'];
		...
		// Param Validation, type argument is required!
